...
evals %>%
  ...
  ggtitle("Scatter plot of Average Beauty Rating to Average Eval")
...
***For a average beauty increased bby 1 the average evaluation rating goes up by 0.07***
...
***For an average beauty rating of 0 the average evaluation rating is 3.88. This doesn't make sense in the date as there are not beuty ratings that are 0.***
...
***A male professor on average scores 0.14 higher on evalutions than a female professor. on average a femals professor scores 4.09 on the ratings.***
...
$$
\widehat{score}_i = 4.28 - 0.12 \times \text{Tenure Track} - 0.14 \times \text Tenured_i
$$

***The average rating for a teaching track professor is 4.28. The average rating for a tenure track professor is 0.12 points lower than a tcaching track professor, The average rating*for a tenured professor is 0.14 points lower than a teaching professor>***
...
$$
\widehat{score} = 4.14 + 0.14 \times teaching + 0.02 \times Tenure tracks
$$
